...
int main()
{
    ...
    pthread_t direçaoX_thr;
    pthread_t direçaoY_thr;
    ...
    pthread_create(&direçaoX_thr, NULL, dirX, &args);
    pthread_create(&direçaoY_thr, NULL, dirY, &args);
    ...
    pthread_join(direçaoX_thr, NULL);
    pthread_join(direçaoY_thr, NULL);
